...
public class JPABasicTest01 {
    ...
    public void testCode04() {
        //내부적으로 select로 번호를 확인하고 , 없으면 insert , 있으면 update 를 처리함
        Memo result= memoRepository.save(Memo.builder().mno(50L).writer("업데이트 완 !").text("update!").build());
        System.out.println("업데이트 된 엔티티" + result);
    }
